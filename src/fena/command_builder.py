...
class CommandBuilder(Builder):
    ...
    def __repr__(self):
        return "CommandBuilder[state={}, execute={}, scoreboard={}, function={}, simple={}]".format(
            repr(self.state), repr(self._execute), repr(self._scoreboard), repr(self._function), repr(self._simple))
...
class ScoreboardBuilder(Builder):
    valid_types = {"players_math", # "players_set", "players_add", "players_remove", "players_test",
                   "players_special", # "players_reset", "players_enable", "players_get",
