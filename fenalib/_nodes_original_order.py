...
class SimpleCmdNode(NamedTuple, MainCmdNode):
    tokens: List[Token, SelectorNode, JsonObjectNode, NbtObjectNode, NamespaceIdNode]
...
class JsonArrayNode(NamedTuple, JsonNode):
    values: List[Token, JsonArrayNode, JsonObjectNode]
