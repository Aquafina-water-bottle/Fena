...
def test_effects():
    ...
    test_cmd("effect @a + saturation 1000000 0",       "effect @a minecraft:saturation 1000000 0 true")
    ...
    test_cmd("effect @a + minecraft:saturation 1000000 0",       "effect @a minecraft:saturation 1000000 0 true")
