...
def test_jsons():
    test_json(
        ...
        r'{"text":"","extra":[{"text":"[","color":"gray"},{"text":"MM","color":"gold","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Mastermind","color":"gold"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1217546713"}},{"text":"]","color":"gray"},{"text":": "},{"text":"The correct combo is ","color":"green"},{"selector":"@e[type=minecraft:armor_stand,scores={MMrn=12},tag=MMCorrect1]"},{"text":", ","color":"green"},{"selector":"@e[type=minecraft:armor_stand,scores={MMrn=12},tag=MMCorrect2]"},{"text":", ","color":"green"},{"selector":"@e[type=minecraft:armor_stand,scores={MMrn=12},tag=MMCorrect3]"},{"text":" and ","color":"green"},{"selector":"@e[type=minecraft:armor_stand,scores={MMrn=12},tag=MMCorrect4]"},{"text":"!","color":"green"}]}')
    ...
    # selectors
    test_json(r'{"selector":"@a[_pl=1..]"}', r'{"selector":"@a[scores={fena.pl=1..}]"}')
    test_json(r'{"score":{"objective":"_pl","name":"@a[_pl=1..]"}}', r'{"score":{"objective":"fena.pl","name":"@a[scores={fena.pl=1..}]"}}')
